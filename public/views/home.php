            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                            ...
                            <td>
                                <a href="edit.php" class="btn btn-primary btn-sm"><i class="bi bi-pencil"></i></a>
                                <button type="button" class="btn btn-danger btn-sm btn-trash" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-trash"></i></button>
                            </td>
                        </a>
                    </tr>
